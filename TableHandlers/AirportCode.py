########################################################################################################################
#CLASS NAME: AirportCode
#Description:
# Performs ETL for airport_codes dimension.
...
class AirportCode:
    ...
    def data_cleansing(self, df):
        ...
        cleansedDF = df.where(col("iso_country") == "US").withColumn("elevation_ft",
                                                                     col("elevation_ft").cast(
                                                                         "float")).withColumn("iso_region",
                                                                                              substring(col(
                                                                                                  "iso_region"),
                                                                                                  4, 2))
